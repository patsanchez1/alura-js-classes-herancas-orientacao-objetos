...
//construir a view, construir a interface que o usuário interage
export class PersonagemView {
  ...
  //essa função preenche o conteúdo interno de uma UL com várias li
  render() {
  ...
  criaPersonagem = (personagem) => {
    ...
    <div class="container-superior">
        ...
        <div class="container-descricao">${personagem.constructor.descricao}
            <p class="descricao"></p>
        </div>
    </div>
